...
RouteModel::Node *RoutePlanner::NextNode() {
  ...
  std::sort(open_list.begin(), open_list.end(),
            [](RouteModel::Node *firstnode, RouteModel::Node *secondnode) {
              return ((firstnode->g_value + firstnode->h_value) >
                      (secondnode->g_value + secondnode->h_value));
            });
